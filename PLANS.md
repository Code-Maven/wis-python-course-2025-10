...
* You are welcome to use your mother tongue when talking to AI.
* The code and the comments should be all in English. Not Italian, Hebrew, etc. so others who don't speake that language will be able read it.
...
* [Python and Biology](https://python.code-maven.com/python-science/biology)


* How can we verify that our code does the right thing?
* How can we make sure our code keeps doing the right thing?

* Data sets from [Kaggle](https://www.kaggle.com/)
...
* Pick 2 students that you don't know. Look at their web site. Open an issue on the repository of their web site and write what you liked about their site and what did you miss, how they might improve it.
When picking a student select one who does NOT yet have 2 issues. This way everyone will get 2 issues.
* Once you received such an issue, react to it and when you feel you have fulfilled the request (or decided you don't want to do that) close it.

* In the `day03` folder create a module with


* Open an issue on our repository with a title `day03 Your Name` linking to where your assignment is and linking to the two issues you opened.
